...
<section id="two" class="spotlights">
	<section>
		<a href="" class="image">
			<img src="{% link assets/images/AppZen.png %}" alt="" data-position="center center" style="margin-left: 30px; margin-top: 200px; "/>
		</a>
		<div class="content">
			<div class="inner">
				<header class="major">
					...
					<p>Customer Value Management Intern<br/>Dec 2024 - June 2025</p>
				<p>
					<ul>
						...
						<li>Improved data extraction performance by training and fine-tuning 5+ AI models using structured prompts and sample datasets.</li>
